        ...
        <div className="py-12 grid grid-cols-2 bg-crimson text-white">
          <div className="flex flex-col col-span-1">
            ...
            <p className="px-12 pt-6">
              Software developer with 2 years experience in Frontend
              developement. Successfully created websites for a number of
              services and firms.
            </p>
          </div>
        ...
        <div className="my-12 grid grid-cols-2">
          ...
          <div className="col-span-1 flex flex-col">
            ...
            <ul className="px-16 mt-4 gap-y-4 flex flex-col list-disc">
              ...
              <li>
                Created frontend for an Archival System used by the Synod
                Council, Mizoram using Vue and Nuxt
              </li>
            </ul>
